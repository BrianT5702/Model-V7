...
const EditProject = ({ project, onClose, onSuccess }) => {
    ...
    return (
        <ModalOverlay className="bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="max-w-2xl w-full bg-white p-8 rounded-2xl shadow-xl border border-gray-100 relative max-h-[90vh] overflow-y-auto modal-scroll-panel">
                {/* Close Button */}
                <button
                    onClick={onClose}
